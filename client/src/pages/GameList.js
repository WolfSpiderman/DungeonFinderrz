      ...
      <div>
        ...
        {loading ? (
          ...
          <ul className="gameList">
            {gameList.map((game) => {
              return (
                <GameCard className="gameCard" key={game._id} id={game._id} title={game.title} location={game.location} date={game.date} slots={game.maxPlayers} players={game.players}/>
              );
            })}
          </ul>
        )}
